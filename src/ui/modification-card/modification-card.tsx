...
export const ModificationCard: FC<any> = (props) => {
  ...
  return (
    <li className={classes.modificationCardBlock}>
      ...
      <Link target="_blank" href={href}>
        <Pdf style={{ position: 'absolute', right: '25px', bottom: '90px' }} />
      </Link>
      <button
        className={cnContainerButton}
        onClick={() => {
          ChangeArrayWithAllOrderPosition(info);
        }}
      >
