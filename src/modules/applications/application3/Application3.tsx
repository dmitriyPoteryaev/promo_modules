        ...
        <section className={classes.application3}>
          ...
          <div className={classes.application3_shotDescription}>
            ...
            <article>
              ...
              <p>
                akYtec's engineering team has successfully completed a project
                for a client managing a dairy farm. The client sought to collect
                data from standalone structures, specifically cow shelters, to
                ensure optimal living conditions for the livestock. To achieve
                this, we utilized a beta version of akYtec Cloud, in conjunction
                with our sensors and I/O modules.
              </p>
            </article>
          </div>
          <article className={classes.application3_textDescription}>
            ...
            <p>
              Each standalone building is equipped with a dispatching panel that
              houses Mx210 modules and a network gateway. The building's
              engineering system parameters are monitored by input/output
              modules featuring Ethernet Bypass technology. This technology
              ensures continuous data transmission between modules in the event
              of a module failure. The parameters monitored include:
            </p>
            <ul className={classes.application3_textDescription_listSteps}>
              ...
              <li>
                - Status of engineering systems, including signals from gas
                analyzers.
              </li>
              <li>
                - Position of automatic circuit breakers and backup supply
                parameters.
              </li>
            </ul>
            <header>akYtec Cloud Features:</header>
            <ul>
            <li>- Visualization of parameters on the dispatcher's workstation through schematics.</li>
            <li>- Maintenance of event logs and archives.</li>
            <li>- Adjustment of threshold values for various parameters.</li>
            <li>- Easy scalability and adaptability of the dispatching system to meet additional requirements.</li>
            </ul>
            ...
            <li>- Easy scaling and adaptation of the monitoring system to meet future requirements.!</li>
            </ul>
          </article>
