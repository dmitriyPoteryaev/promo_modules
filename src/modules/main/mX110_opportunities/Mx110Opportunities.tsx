...
const cards = [
  ...
  {
    topInscription: 'Diagnostics of',
    bottomInscription: 'network status',
    svg: <SvgMx110427321542 />
  },
  {
    topInscription: 'Up to 32DI / 32DO',
    bottomInscription: 'Up to 8AI / 8AO',
...
export const Mx110Opportunities: FC = () => {
  return (
    <section className={classes.Mx110opportunities} id="Mx110">
      ...
      <div className={classes.Mx110opportunities_fullInfo}>
        ...
        <div className={classes.Mx110opportunities_wrapperImg}>
          <Image
            className={classes.Mx110opportunities_imgModule}
            width={626}
            height={626}
            src="/png/main/Oppotunities/Mx110/Mx110.png"
            alt="Mx210"
          />
