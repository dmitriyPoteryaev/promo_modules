  ...
  return (
    <section className={classes.swiper_block}>
      <article>
        ...
        <p>
          Universal Modbus RTU I/O modules Mx110 offer cost effective and flexible solution for
          centralized and decentralized systems. The modules are connected to the Master using a
          two-wire communication line up to 1200 m.
        </p>
