...
export const ModuleAdAboutModBus: FC = () => {
  return (
    <div className={classes.moduleAd}>
      ...
      <div
        className={classes.moduleAd_img}
        style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'end' }}
      >
      ...
      <article style={{ maxWidth: '1230px', width: '100%' }}>
        <div className={classes.moduleAd_description}>
          <header className={classes.moduleAd_header}>
            Modbus TCP/RTU universal remote I/O modules
          </header>
          <ul>
            <li>Modules are compatible with third-party PLCs</li>
            <li>
              Supported protocols: Modbus TCP/ RTU, MQTT, SNMP – ability to connect modules to
              CLOUD, SCADA, and IIoT APPs
            </li>
        ...
        <div style={{ paddingLeft: '35px' }} className={classes.moduleAd_modulePhoto}>
          <Image src={modulePhoto} alt="module" />
        </div>
      </article>
    </div>
  );
    ...
    <div className={classes.moduleAd}>
      ...
      <article>
        <div className={classes.moduleAd_description}>
          ...
          <p>
            Daisy chain connectivity offers flexible cabling and space saving capabilities. With
            Ethernet auto-bypass function supported to prevent accidental power failures if one of
            the modules unexpectedly shuts down.
          </p>
          <Button variant="magenta" size="medium">
            <Link
              style={{
        ...
        <div
          className={classes.moduleAd_modulePhoto}
          style={{ marginTop: '117px', paddingTop: 'unset' }}
        >
          <Image width={685} height={368} src={'/png/main/Ad/Mx210.svg'} alt="module" />
        </div>
      </article>
    </div>
  );
